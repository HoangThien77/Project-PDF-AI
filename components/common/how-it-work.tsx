...
export default function HowItWorksSection() {
  ...
  const steps: Steps[] = [
    ...
    },
    {
      ...
      label: "Get Your Summary", // Sửa label trùng lặp
      description: "Receive a concise, easy-to-read summary in seconds", // Sửa description trùng lặp
    },
  ];
